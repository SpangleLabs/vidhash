...
class FFmpeg:
    ...
    def __init__(
        self,
        executable: str = ...,
        global_options: Optional[Union[str, List[str]]] = ...,
        inputs: Optional[Dict[str, Optional[str]]] = ...,
        outputs: Optional[Dict[str, Optional[str]]] = ...,
    ) -> None: ...
    def run(
        self, input_data: Optional[bytes] = ..., stdout: Optional[IO[AnyStr]] = ..., stderr: Optional[IO[AnyStr]] = ...
    ) -> Tuple[bytes, bytes]: ...
    async def run_async(
        self,
        input_data: Optional[bytes] = ...,
        stdout: Optional[Union[int, IO[AnyStr]]] = ...,
        stderr: Optional[Union[int, IO[AnyStr]]] = ...,
    ) -> Process: ...
